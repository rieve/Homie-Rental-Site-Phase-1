...
<section class="singlehouse">
  <div class="container">
    <div class="row">
      <div class="col-sm-12 col-md-7 col-lg-8">
        <span class="sub-button">
          <input type="text" class="text" value="localhost/projecthomiez/singleflat.php?id=<?php echo $code; ?>">
                  ...
                  while ($row=mysqli_fetch_assoc($result)) 
                  {
                    if ($row['house_id']==$code) 
                    {
                      ...
                      <ul>
                        ...
                        <li><i class="las la-building"></i><span class="roomfloor">'. $row['floor'] .' </span>Floor</li>
                        <li><i class="las la-kaaba"></i><span class="roomfloor">'. $row['room'] .' </span>Rooms</li>
                      </ul>';
                      echo $output;
                    }
                  }
