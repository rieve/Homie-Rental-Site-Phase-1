...
?>
<!-- flat_register_form -->
<section class="registerflat">
    <div class="container">
        <h3>Register your flat</h3>
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                        <div class="card">
                            <div class="card-body">
                                <form class="form" role="form" autocomplete="off" action="flat_data.php" method="POST" enctype="multipart/form-data">
